...
actividad([correr|Resto],Resto,masculino).
actividad([ciclismo|Resto],Resto,masculino).
actividad([yoga|Resto],Resto,femenino).
actividad([pilates|Resto],Resto,femenino).
actividad([crossfit|Resto],Resto,masculino).
actividad([baile|Resto],Resto,femenino).
actividad([entrenamiento,funcional|Resto],Resto,masculino).
actividad([zumba|Resto],Resto,femenino).
actividad([patinaje|Resto],Resto,masculino).
actividad([caminata|Resto],Resto,femenino).
actividad([pesas|Resto],Resto,masculino).
actividad([futbol|Resto],Resto,masculino).
actividad([baloncesto|Resto],Resto,masculino).
actividad([voleibol|Resto],Resto,femenino).
actividad([tenis|Resto],Resto,masculino).
actividad([padel|Resto],Resto,masculino).
actividad([squash|Resto],Resto,masculino).
actividad([rugby|Resto],Resto,masculino).
actividad([hockey|Resto],Resto,masculino).
actividad([badminton|Resto],Resto,masculino).
actividad([escalada|Resto],Resto,masculino).
...
% Funcion para importar en la interfaz
bnf_verif(Mensaje):- procesar_cadena(Mensaje,OracionListaStrings),string_a_atom(OracionListaStrings,OracionLista),verifica(OracionLista).
